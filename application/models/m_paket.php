...
class M_paket extends CI_Model {
	...
	public function edit_info_paket($id)
	{
		...
		return $this->db->get('info_paket')->row_array();
	}

	public function update_info_paket($id_info_paket, $data)
	{
		$this->db->where('id_info_paket', $id_info_paket);
		$this->db->update('info_paket', $data);
	}
